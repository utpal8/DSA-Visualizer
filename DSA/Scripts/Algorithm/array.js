...
cleareverything();
  ...
  length = typed.length
    ...
    for (var i = 0 ; i < typed.length ; ++i)  {
      ...
      tabledata.innerHTML += '<div id="aitemdiv'+ i+'"  style="text-align:center; position:absolute; z-index:1">         <p id="aitemindex'+i +'" style="position:absolute; color:#8ab6d6; margin-top:60px; margin-left:35px; font-size:70%";>'+i+'</p>             <p id= "aitemval'+i +'" class="arrayitem">'+ r +'</p>                        </div>'
...
tabledata.innerHTML += `<div id="${cellid}itemdiv${i}"  style="text-align:center; position:absolute; z-index:1">         <p id="${cellid}itemindex${i}" style="position:absolute; color:#8ab6d6; margin-top:67px; margin-left:35px; font-size:37%";>${i}</p>             <p id= "${cellid}itemval${i}" class="arrayitem">0</p>                        </div>`
...
async function arraynodes()
{
  ...
  let ii =0;
    ...
    newnode = '<div id="'+ii+'" style="left:0;top:0;"  class="dragg" > <div class="treenode" id="'+ ii+"treetop" +'" style="margin-left:35px;"></div>  <div class="treenode" id="'+ ii+"treeleft" +'" style="margin-left:18px; margin-top:70px;"></div>   <div class="treenode" id="'+ ii+"treeright" +'" style="margin-left:54px; margin-top:70px;"></div> <p  style="position:absolute;color:#8ab6d6; font-size:70%; left:20px;" id="'+ ii+"bottom" +'">'+ii +'</p>  <p  style="color:white;margin-top:-2px;margin-left:-15px; font-size:50%;display:none;" id="'+ ii+"height" +'">'+"1" +'</p> <p  style="color:white;margin-top:-2px;margin-left:-15px; font-size:50%;display:none;" id="'+ count+"height" +'">'+"1" +'</p>  <p  id="'+ ii+"treeval" +'" class="t">'+storedarray[ii]+'</p>   </div>';
