...
Log(`<span style="font-size:140%;color:#8ab6d6;">Total Iterations : 20</span>`)
...
async function cordicutil( theta, n, sign,cosfactor)
{
  ...
  for (k=0; k<n; ++k)
  {
    ...
    Log(`<span style="font-size:130%;color:#8ab6d6;">Iteration : ${k+1} out of 20</span>`)
...
async function cordic(deg) {
    ...
    if (deg < 0 || deg > 360) {
        ...
        Log(`<span style="font-size:125%;color:#8ab6d6;">Enter value from 0 to 360.</span>`)
