...
async function TowerOfHanoi(no) {
  ...
  if (no >10 )  {
   ...
   let disk = `<div id=pega class="towers" style="width:${20*nofdisk}px; height : 20px; background-color:#8ab6d6;position:absolute;top:${230+(nofdisk+1)*20}px;left:${pos["A"]}px;text-align:center;border-radius:10px;border-style:solid;border-color:black;border-width:2px;"><p style="color:black;margin-top:-3px;">Peg A</p></div>`

document.body.insertAdjacentHTML("afterbegin",disk);

 disk = `<div id=pegb class="towers" style="width:${20*nofdisk}px; height : 20px; background-color:#8ab6d6;position:absolute;top:${230+(nofdisk+1)*20}px;left:${pos["B"]}px;text-align:center;border-radius:10px;border-style:solid;border-color:black;border-width:2px;"><p style="color:black;margin-top:-3px;">Peg B</p></div>`

document.body.insertAdjacentHTML("afterbegin",disk);


 disk = `<div id=pegc class="towers" style="width:${20*nofdisk}px; height : 20px; background-color:#8ab6d6;position:absolute;top:${230+(nofdisk+1)*20}px;left:${pos["C"]}px;text-align:center;border-radius:10px;border-style:solid;border-color:black;border-width:2px;"><p style="color:black;margin-top:-3px;">Peg C</p></div>`
