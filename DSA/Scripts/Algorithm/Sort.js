...
async function qs(  low,  high)
{
    if (low < high)
    {
        ...
        if (low < pi-1) {  await display('Calling QuickSort( '+ (low) + ' , ' + (pi-1) + ' )' );
         ...
         $('#Q').append('<p style="font-size:250%;color:#8ab6d6;font-family:Segoe UI;">'+'QuickSort( '+ (low) + ' , ' + (pi-1) + ' )'+'</p>')
        ...
        $('#Q').append('<p style="font-size:250%;color:#8ab6d6;font-family:Segoe UI;">'+'QuickSort( '+ (pi+1) + ' , ' + (high) + ' )'+'</p>')
...
//$('#Q').append('<p style="font-size:250%;color:#8ab6d6;font-family:Segoe UI;">'+'QuickSort( '+ (0) + ' , ' + (length-1) + ' )'+'</p>')
