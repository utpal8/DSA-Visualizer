...
Object.defineProperty(window, 'key', {
  get: function() {
    Log(`You are using random <span style="font-size:120%;color:#8ab6d6;">key</span><br>To define specific value then edit the parameter<br>For example<br><span style="color:red;">RBTreeinsert(${Math.ceil(Math.random() * 1000)})</span>`)
...
function RBnode(element) {
    ...
    newnode = '<div id="'+count+'" style="transform:scale(.8,.8); background-color:red;left:1250px;top:150px;transition:'+ speed+'ms linear;"  class="dragg" > <div class="treenode" id="'+ count+"treetop" +'" style="margin-left:35px;"></div>  <div class="treenode" id="'+ count+"treeleft" +'" style="margin-left:18px; margin-top:70px;"></div>   <div class="treenode" id="'+ count+"treeright" +'" style="margin-left:54px; margin-top:70px;"></div> <p  style="position:absolute;color:#8ab6d6; font-size:70%; left:20px;" id="'+ count+"bottom" +'">'+count +'</p><p  id="'+ count+"col" +'" style="display:none;">'+"red"+'</p>   <div style="position:absolute; text-align:center; top:65px; left:38px;height:1px; width:20px;"><p  style="color:white; font-size:70%; " id="'+ count+"height" +'">'+"1" +'</p></div>   <p  id="'+ count+"treeval" +'" class="t">'+element+'</p>     </div>';
