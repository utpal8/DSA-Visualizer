...
const clearscreen = function(e)  {
  ...
  function maketable(X,Y,m,n)   {
    ...
    for (let u =0 ; u <=n ; u++)  {
      ...
      $("#lcstable").append( `<td class="floyd" id="lcs${(u)}" style="background-color : #8ab6d6;">  <div id="lcs${(u)}div" style="z-index:1; text-align:center;"> <p id="lcs${(u)}val" style="color:black; text-align:center;position:absolute;left:30px;">${Y.charAt(u-1)}</p></div></td>`);
    ...
    for (let y = 0 ; y <= m ; y++) {
      ...
      $("#lcstable").append( `<td class="floyd" id="lcsr${(y)}" style="background-color : #8ab6d6;">  <div id="lcsr${(y)}div" style="z-index:1; text-align:center;"> <p id="lcsr${(y)}val" style="color:black; text-align:center;position:absolute;left:35px;">${X.charAt(y-1)}</p></div></td>`);

      for (let x = 0 ; x <= n ; x++) {

          $("#lcstable").append( `<td class="floyd" id="lcs${(y)}-${(x)}">  <div id="lcs${(y)}-${(x)}div" style="z-index:1; text-align:center;"> <p id="lcs${(y)}-${(x)}val" style="color:#8ab6d6; text-align:center">${"-"}</p>  </div></td>`);
...
N=N-1;
  ...
  $("#fibtable").append( `<td class="floyd" id="fibtop0" style="background-color : #8ab6d6; ">  <div id="fibtop1div" style=" z-index:1; text-align:center;  max-height:10px;"> <p id="fibtop0val" style="z-index:3;color:black;max-height:5px;">Fib</p></div></td>`);

    $("#fibtable").append( `<td class="floyd" id="fibtop1" style="background-color : #8ab6d6;">  <div id="fibtop1div" style="z-index:1; text-align:center;max-height:10px;"> <p id="fibtop1val" style="z-index:3;color:black;max-height:5px;">n-2</p></div></td>`);

    $("#fibtable").append( `<td class="floyd" id="fibtop2" style="background-color : #8ab6d6;">  <div id="fibtop2div" style="z-index:1; text-align:center;max-height:10px;;"> <p id="fibtop2val" style="z-index:3;color:black;max-height:5px; ">n-1</p></div></td>`);

    $("#fibtable").append( `<td class="floyd" id="fibtop3" style="background-color : #8ab6d6;">  <div id="fibtop3div" style="z-index:1; text-align:center;max-height:10px;"> <p id="fibtop3val" style="z-index:3;color:black;max-height:5px; ">n</p></div></td>`);



    $("#fibtable").append("<tr>");

    $("#fibtable").append( `<td class="floyd" id="fibr" style="background-color : #8ab6d6;">  <div id="fibr1div" style="z-index:1; text-align:center;"> <p id="fibr1val" style="color:black;">Data</p></div></td>`);


        $("#fibtable").append( `<td class="floyd" id="fibn2" style="overflow-y:visible;">  <div id="fibn2div" style="z-index:3; text-align:center;position:absolute;"> <p id="fibn2val"  style="position:absolute;color:#8ab6d6;z-index:5;top:0;left:0; transition:${speed}ms linear;">0</p>  </div></td>`);

        $("#fibtable").append( `<td class="floyd" id="fibn1" style="overflow-y:visible;" >  <div id="fibn1div" style="z-index:3; text-align:center;position:absolute;"> <p id="fibn1val"  style="position:absolute;color:#8ab6d6;z-index:5;top:0;left:0;transition:${speed}ms linear; ">1</p>  </div></td>`);

        $("#fibtable").append( `<td class="floyd" id="fibn" style="overflow-y:visible;">  <div id="fibndiv" style="z-index:3; text-align:center;position:absolute;"> <p id="fibnval"  style="position:absolute;color:#8ab6d6;z-index:5;top:0;left:0;transition:${speed}ms linear; ">1</p>  </div></td>`);
...
async function PascalTriangle( n)
{
  ...
  for (let y = 0 ; y < n ; y++) {
    ...
    for (let x = 0 ; x < n ; x++) {
        ...
        $("#lcstable").append( `<td class="floyd" id="lcs${(y)}-${(x)}">  <div id="lcs${(y)}-${(x)}div" style="z-index:1; text-align:center;min-width:70px;"> <p id="lcs${(y)}-${(x)}val" class="transit" style="color:#8ab6d6; text-align:center;transition:${speed}ms linear;">${"-"}</p>  </div></td>`);
   ...
   $("#lcstable").append("</table>");
    ...
    for (let line = 0; line < n; line++)
    {
        ...
        if (line == i || i == 0)  {
          ...
          await hilight(`lcs${line}-${i}` , "#8ab6d6" , "300ms", 400 )
        }
 ...
 document.getElementById(`lcs${line-1}-${i-1}val`).style.color = "black";
          ...
          hilight(`lcs${line-1}-${i-1}` ,"#8ab6d6" , "300ms", 400 )
          await   hilight(`lcs${line-1}-${i}` , "#8ab6d6" , "300ms", 400 )
